...
import { fetchCatalogStats } from "../../services/axeCatalog";
...
const AnimatedStats = () => {
  ...
  // Un échec fait disparaître le bandeau plutôt que d'afficher un chiffre de
  // repli : un nombre inventé est pire qu'un bandeau absent.
