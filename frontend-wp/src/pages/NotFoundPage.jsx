      ...
      <section className="relative pt-32 pb-32 md:pt-40 md:pb-32 overflow-hidden min-h-[600px] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            {/* ─── Suggestions ───────────────────────────────────────────
                On renvoie vers la boutique, qui liste les rayons réels lus
                dans notre base, plutôt que de deviner des slugs en dur — ce
                qui mènerait au mieux à une autre catégorie. */}
